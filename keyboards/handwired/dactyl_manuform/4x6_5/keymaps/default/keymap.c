...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
	[_BASE] = LAYOUT( \
	  ...
	  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
		  KC_LSFT, LCTL_T(KC_A), LGUI_T(KC_S), LALT_T(KC_D), LSFT_T(KC_F),    KC_G,             KC_H, RSFT_T(KC_J), LALT_T(KC_K),  LGUI_T(KC_L), RCTL_T(KC_SCOLON), KC_QUOT,\
	  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
	...
	[_LOWER] = LAYOUT( \
	  ...
	  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
		                      LOWER, KC_LALT,  KC_DEL, KC_LGUI, XXXXXXX,    XXXXXXX, KC_LALT, KC_SPACE,  KC_ENTER,  RAISE \
		                                  //|--------------------------|  |--------------------------|
	),
    /*
	[_LOWER_OLD] = LAYOUT( \
